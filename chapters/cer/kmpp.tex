...
\begin{proof}
    ...
    \begin{align*}
        ...
        & \leq \frac{1}{|A|} \sum_{\bm a \in A} \left(|A| \| \bm a - \bm \mu \|^2 + \sum_{\bm x \in A} \| \bm x - \bm \mu \|^2\right) && (\bm \mu \text{ centroide di } A) \\
	...
	di conseguenza
	\[ \phi \left(\C_i, A \right) = \sum_{\bm a \in A} \min \left\{ \phi \left(\C_{i-1}, \bm a\right), \ \| \bm a - \bm \mu_A \right\} \]
