...
Si tratta di un limite superiore al valore del gioco; con $\alpha \in [0,1]$ probabilità di predire $+1$ con label effettivo $-1$, subendo $c^+ = c(+1,-1)$, e conseguentemente probabilità $(1-\alpha)$ di predire $-1$ con label effettivo $+1$, subendo $c^- = c (-1, +1)$.
