...
\end{align*}
In altre parole, sicuramente la somma di tutti i pesi ($W_{T+1}$) sarà maggiore o uguale al peso di un singolo esperto ($w_{T+1} (k)$). Questo è un lower bound per la variazione dei pesi.
