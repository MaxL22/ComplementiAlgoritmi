...
Il problema del \textsc{Coupon Collector} è definito come segue: sia $X_1, X_2, \dots$ una sequenza di variabili casuali indipendenti e uniformemente distribuite su $n$ valori distinti $a_1, \dots, a_n$
