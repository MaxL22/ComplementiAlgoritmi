...
\begin{document}
    ...
    \input{chapters/compl/riduz}
    \input{chapters/compl/pnp}
    \input{chapters/compl/npc}

    \chapter{Algoritmi Probabilistici}

    \input{chapters/prob/prob}
    \input{chapters/prob/randclasses}
    \input{chapters/prob/vonNeumann}
    \input{chapters/prob/coupon}
    \input{chapters/prob/reservoir}
    \input{chapters/prob/karger}

    \chapter{Hashing e Randomizzazione}

    \input{chapters/her/hu}
    \input{chapters/her/approx}
    \input{chapters/her/jl}

    \chapter{Clustering e Randomizzazione}

    \input{chapters/cer/cc}
    \input{chapters/cer/km}
    \input{chapters/cer/kmpp}

    \chapter{Giochi e Mercati}

    \input{chapters/gem/he3}
    \input{chapters/gem/auctions}
    \input{chapters/gem/sp}
    \input{chapters/gem/minimax}
    \input{chapters/gem/boosting}
